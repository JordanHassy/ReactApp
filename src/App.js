...
function App() {
  ...
  let exampleDescription = "You awaken in the heart of a lush forest surrounded by tall, ancient trees. You see the faint glow of a small Elven village to the north, an Athenian city to the west, Nomadic camps to the east, and the Dwarven kingdom to the north.";
  let exampleQuestion = "Which path will you choose?";
  let exampleTitle = "Welcome to the World of Terraquor!";
  ...
  let exampleOptions = [{option: "Head towards the Elven village", action: () => {alert('option 1 clicked')}},
  ...
  return (
    <div className="App" style={{backgroundImage: "url(/titleImage.jpg)"}}>
      ...
      <TextBox options = {exampleOptions} description={exampleDescription} question={exampleQuestion} title={exampleTitle}/>
    </div>
  );
}
export default App;
